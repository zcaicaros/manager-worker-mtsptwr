...
x1=np.arange(1, 101)
min_50_5=np.load('../outer_assignment/counts/count_min_50_5.npy')
max_50_5=np.load('../outer_assignment/counts/count_max_50_5.npy')
min_150_5=np.load('../outer_assignment/counts/count_min_150_5.npy')
max_150_5=np.load('../outer_assignment/counts/count_max_150_5.npy')
'''
