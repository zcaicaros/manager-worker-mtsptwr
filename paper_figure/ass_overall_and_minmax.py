...
ax.set_xlim(-3, 103)
x = np.arange(1, 101)
l4 = plt.plot(x, max2, '-', label='minmax (n={}, m={}):max'.format(n, m), linewidth=3, color='coral', ms=9)
l3 = plt.plot(x, min2, '--', label='minmax (n={}, m={}):min'.format(n, m), linewidth=3, color='coral', ms=9)
l5 = plt.plot(x, mean2, '--', label='', linewidth=1, color='red', ms=9)
l2 = plt.plot(x, max1, '-', label='overall (n={}, m={}):max'.format(n, m), linewidth=3, color='royalblue', ms=9)
l1 = plt.plot(x, min1, '--', label='overall (n={}, m={}):min'.format(n, m), linewidth=3, color='royalblue', ms=9)
