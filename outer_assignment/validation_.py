...
from outer_assignment.policy_ import action_sample, get_reward
import torch
from torch_geometric.data import Data
from torch_geometric.data import Batch


def validate(instances, p_net, no_agent, validation_model, beta, device):
    ...
    reward, rejs, lengths = get_reward(action, instances.to(device), no_agent, validation_model, beta)  # reward: tensor [batch, 1]
