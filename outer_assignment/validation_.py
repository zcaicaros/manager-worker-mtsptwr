...
def validate(instances, p_net, no_agent, validation_model, device):
    ...
    reward, rejs, lengths = get_reward(action, instances.to(device), no_agent, validation_model)  # reward: tensor [batch, 1]
